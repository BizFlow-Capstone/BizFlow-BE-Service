...
SET @col_deleted_at_exists = (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'Users' AND COLUMN_NAME = 'DeletedAt');
...
SET @col_is_deleted_exists = (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'Users' AND COLUMN_NAME = 'IsDeleted');
...
-- =============================================
-- 1. Ensure DeletedAt exists
SET @col_deleted_at_exists = (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'BusinessLocations' AND COLUMN_NAME = 'DeletedAt');
SET @sql = IF(@col_deleted_at_exists = 0,
...
-- 2. Migrate data
SET @col_is_deleted_exists = (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'BusinessLocations' AND COLUMN_NAME = 'IsDeleted');
SET @sql = IF(@col_is_deleted_exists > 0,
...
-- =============================================
-- 1. Ensure DeletedAt exists
SET @col_deleted_at_exists = (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'Products' AND COLUMN_NAME = 'DeletedAt');
SET @sql = IF(@col_deleted_at_exists = 0,
...
-- 2. Migrate data
SET @col_is_deleted_exists = (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'Products' AND COLUMN_NAME = 'IsDeleted');
SET @sql = IF(@col_is_deleted_exists > 0,

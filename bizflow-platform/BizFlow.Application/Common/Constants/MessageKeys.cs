...
namespace BizFlow.Application.Common.Constants
{
    ...
    public static class MessageKeys
    {
        ...
        public const string TemplateMustHaveAtLeastOneActiveVersion = "TEMPLATE_MUST_HAVE_AT_LEAST_ONE_ACTIVE_VERSION";
        public const string AdminAccTemplateCodeRequired = "ADMIN_ACC_TEMPLATE_CODE_REQUIRED";
        public const string AdminAccNameRequired = "ADMIN_ACC_NAME_REQUIRED";
        public const string AdminAccApplicableGroupsRequired = "ADMIN_ACC_APPLICABLE_GROUPS_REQUIRED";
        public const string AdminAccInvalidDataSourceType = "ADMIN_ACC_INVALID_DATA_SOURCE_TYPE";
        public const string AdminAccTemplateCodeExists = "ADMIN_ACC_TEMPLATE_CODE_EXISTS";
        public const string AdminAccVersionLabelRequired = "ADMIN_ACC_VERSION_LABEL_REQUIRED";
        public const string AdminAccVersionLabelTooLong = "ADMIN_ACC_VERSION_LABEL_TOO_LONG";
        public const string AdminAccVersionLabelExists = "ADMIN_ACC_VERSION_LABEL_EXISTS";
        public const string AdminAccDeleteActiveVersionNotAllowed = "ADMIN_ACC_DELETE_ACTIVE_VERSION_NOT_ALLOWED";
        public const string AdminAccDeleteOnlyDraftAllowed = "ADMIN_ACC_DELETE_ONLY_DRAFT_ALLOWED";
        public const string AdminAccCodeRequired = "ADMIN_ACC_CODE_REQUIRED";
        public const string AdminAccExpressionJsonRequired = "ADMIN_ACC_EXPRESSION_JSON_REQUIRED";
        public const string AdminAccExpressionJsonInvalid = "ADMIN_ACC_EXPRESSION_JSON_INVALID";
        public const string AdminAccFormulaCodeExists = "ADMIN_ACC_FORMULA_CODE_EXISTS";
        public const string AdminAccCannotDeactivateOnlyActiveTaxRuleset = "ADMIN_ACC_CANNOT_DEACTIVATE_ONLY_ACTIVE_TAX_RULESET";
        public const string AdminAccBusinessLocationIdMustBePositive = "ADMIN_ACC_BUSINESS_LOCATION_ID_MUST_BE_POSITIVE";
        public const string AdminAccTestLocationOnly = "ADMIN_ACC_TEST_LOCATION_ONLY";
        public const string AdminAccPeriodIdMustBePositive = "ADMIN_ACC_PERIOD_ID_MUST_BE_POSITIVE";
        public const string AdminAccTemplateVersionIdMustBePositive = "ADMIN_ACC_TEMPLATE_VERSION_ID_MUST_BE_POSITIVE";
        public const string AdminAccRulesetIdMustBePositive = "ADMIN_ACC_RULESET_ID_MUST_BE_POSITIVE";
        ...
        public const string AdminAccCannotEditActiveFormula = "ADMIN_ACC_CANNOT_EDIT_ACTIVE_FORMULA";
        public const string AdminAccCannotDeactivateFormulaUsedInActiveTemplate = "ADMIN_ACC_CANNOT_DEACTIVATE_FORMULA_USED_IN_ACTIVE_TEMPLATE";
        ...
        public const string AdminAccCannotAddRowsToActiveVersionWithBooks = "ADMIN_ACC_CANNOT_ADD_ROWS_TO_ACTIVE_VERSION_WITH_BOOKS";
        public const string AdminAccInvalidRowType = "ADMIN_ACC_INVALID_ROW_TYPE";
        public const string AdminAccInvalidPosition = "ADMIN_ACC_INVALID_POSITION";
        public const string AdminAccCannotDeleteRowsFromActiveVersionWithBooks = "ADMIN_ACC_CANNOT_DELETE_ROWS_FROM_ACTIVE_VERSION_WITH_BOOKS";
        public const string AdminAccCannotAddMappingsToActiveVersionWithBooks = "ADMIN_ACC_CANNOT_ADD_MAPPINGS_TO_ACTIVE_VERSION_WITH_BOOKS";
        public const string AdminAccFieldCodeExists = "ADMIN_ACC_FIELD_CODE_EXISTS";
        public const string AdminAccCannotDeleteMappingFromActiveVersionWithBooks = "ADMIN_ACC_CANNOT_DELETE_MAPPING_FROM_ACTIVE_VERSION_WITH_BOOKS";
        public const string AdminAccBusinessTypeCodeExists = "ADMIN_ACC_BUSINESS_TYPE_CODE_EXISTS";
        public const string AdminAccNameCannotBeEmpty = "ADMIN_ACC_NAME_CANNOT_BE_EMPTY";
        public const string AdminAccBusinessTypeStatusInvalid = "ADMIN_ACC_BUSINESS_TYPE_STATUS_INVALID";
        public const string AdminAccInvalidTaxTypes = "ADMIN_ACC_INVALID_TAX_TYPES";
        public const string AdminAccDuplicateTaxTypes = "ADMIN_ACC_DUPLICATE_TAX_TYPES";
        public const string AdminAccTaxRateOutOfRange = "ADMIN_ACC_TAX_RATE_OUT_OF_RANGE";
        public const string AdminAccVersionRequired = "ADMIN_ACC_VERSION_REQUIRED";
        public const string AdminAccEffectiveToMustBeAfterEffectiveFrom = "ADMIN_ACC_EFFECTIVE_TO_MUST_BE_AFTER_EFFECTIVE_FROM";
        public const string AdminAccSourceRulesetNotFound = "ADMIN_ACC_SOURCE_RULESET_NOT_FOUND";
        public const string AdminAccVersionCannotBeEmpty = "ADMIN_ACC_VERSION_CANNOT_BE_EMPTY";

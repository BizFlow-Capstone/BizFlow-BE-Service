...
public partial class GeneralLedgerEntries
{
    ...
    public virtual ICollection<GeneralLedgerEntries> InverseReversedEntry { get; set; } = new List<GeneralLedgerEntries>();

    public virtual GeneralLedgerEntries? ReversedEntry { get; set; }
}

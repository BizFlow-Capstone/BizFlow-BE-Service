namespace BizFlow.Domain.Enums
{
    ...
    /// <para><b>posted</b> — cost is live, has produced GL entries. Edits must go through the replacement flow.</para>
    /// <para><b>cancelled</b> — explicitly cancelled (standalone cancel). GL entries have been reversed.</para>
    /// <para><b>replaced</b> — cancelled as part of the replacement flow; a newer Cost row supersedes it.</para>
    /// </summary>
